...
### Skills
[![My Skills](https://skillicons.dev/icons?i=git,html,idea,java,js,bash,c,css,sass,docker,linux,md,mongodb,nuxtjs,nodejs,py,react,vue,flutter,dart,webpack,bootstrap,ts,vscode,fastapi,unity,&perline=7)](https://skillicons.dev)
